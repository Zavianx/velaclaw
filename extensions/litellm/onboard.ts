...
const litellmPresetAppliers = createDefaultModelPresetAppliers({
  ...
  resolveParams: (cfg: VelaclawConfig) => {
...
export function applyLitellmProviderConfig(cfg: VelaclawConfig): VelaclawConfig {
  return litellmPresetAppliers.applyProviderConfig(cfg);
}

export function applyLitellmConfig(cfg: VelaclawConfig): VelaclawConfig {
