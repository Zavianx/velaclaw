import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "velaclaw/plugin-sdk/account-id";
import { listCombinedAccountIds } from "velaclaw/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: VelaclawConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: VelaclawConfig): string {
