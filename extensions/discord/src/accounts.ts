...
import { resolveAccountEntry } from "velaclaw/plugin-sdk/routing";
import { normalizeOptionalString } from "velaclaw/plugin-sdk/text-runtime";
import type { DiscordAccountConfig, DiscordActionConfig, VelaclawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: VelaclawConfig): ResolvedDiscordAccount[] {
