import { coerceNativeSetting, normalizeAllowFromList } from "velaclaw/plugin-sdk/channel-policy";
import {
...
import type { VelaclawConfig } from "./runtime-api.js";
...
export async function collectDiscordSecurityAuditFindings(params: {
  ...
  addDiscordNameBasedEntries({
    ...
    source: "~/.velaclaw/credentials/discord-allowFrom.json",
  });
