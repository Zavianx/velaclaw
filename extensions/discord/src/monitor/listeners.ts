...
type LoadedConfig = ReturnType<typeof import("velaclaw/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("velaclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("velaclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
