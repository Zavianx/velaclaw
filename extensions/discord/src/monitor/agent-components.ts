...
import { resolveHumanDelayConfig } from "velaclaw/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "velaclaw/plugin-sdk/channel-inbound";
import { isDangerousNameMatchingEnabled } from "velaclaw/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "velaclaw/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "velaclaw/plugin-sdk/media-runtime";
import { createNonExitingRuntime, logVerbose } from "velaclaw/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "velaclaw/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "velaclaw/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("velaclaw/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("velaclaw/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function _loadReplyRuntime() {
  replyRuntimePromise ??= import("velaclaw/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("velaclaw/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__velaclaw_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__velaclaw_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__velaclaw_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__velaclaw_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__velaclaw_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__velaclaw_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Velaclaw form";
  customId = "__velaclaw_discord_component_modal_wildcard__";
  components = [];
