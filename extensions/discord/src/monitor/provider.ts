...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "velaclaw/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "velaclaw/plugin-sdk/channel-contract";
import { registerChannelRuntimeContext } from "velaclaw/plugin-sdk/channel-runtime-context";
import {
  listNativeCommandSpecsForConfig,
  listSkillCommandsForAgents,
  type NativeCommandSpec,
} from "velaclaw/plugin-sdk/command-auth";
import {
  isNativeCommandsExplicitlyDisabled,
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "velaclaw/plugin-sdk/config-runtime";
import type { VelaclawConfig, ReplyToMode } from "velaclaw/plugin-sdk/config-runtime";
import { loadConfig } from "velaclaw/plugin-sdk/config-runtime";
import { createConnectedChannelStatusPatch } from "velaclaw/plugin-sdk/gateway-runtime";
import { getPluginCommandSpecs } from "velaclaw/plugin-sdk/plugin-runtime";
import { resolveTextChunkLimit } from "velaclaw/plugin-sdk/reply-chunking";
import {
  danger,
  isVerbose,
  logVerbose,
...
import { createNonExitingRuntime, type RuntimeEnv } from "velaclaw/plugin-sdk/runtime-env";
import {
  GROUP_POLICY_BLOCKED_LABEL,
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "velaclaw/plugin-sdk/runtime-group-policy";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("velaclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();
