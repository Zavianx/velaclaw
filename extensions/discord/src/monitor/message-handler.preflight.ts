...
import { formatAllowlistMatchMeta } from "velaclaw/plugin-sdk/allow-from";
import {
  buildMentionRegexes,
...
import { resolveControlCommandGate } from "velaclaw/plugin-sdk/command-auth-native";
import { hasControlCommand } from "velaclaw/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "velaclaw/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "velaclaw/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "velaclaw/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "velaclaw/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "velaclaw/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "velaclaw/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "velaclaw/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("velaclaw/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("velaclaw/plugin-sdk/conversation-binding-runtime");
