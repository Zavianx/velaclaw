...
import { loadJsonFile, saveJsonFile } from "velaclaw/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "velaclaw/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("velaclaw.discordThreadBindingsState");
