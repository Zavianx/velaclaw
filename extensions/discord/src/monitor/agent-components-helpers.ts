...
import { createChannelPairingChallengeIssuer } from "velaclaw/plugin-sdk/channel-pairing";
import { resolveCommandAuthorizedFromAuthorizers } from "velaclaw/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, VelaclawConfig } from "velaclaw/plugin-sdk/config-runtime";
...
import { logError } from "velaclaw/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("velaclaw/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
