...
import type { ModelsProviderData } from "velaclaw/plugin-sdk/models-provider-runtime";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("velaclaw/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("velaclaw/plugin-sdk/models-provider-runtime");
