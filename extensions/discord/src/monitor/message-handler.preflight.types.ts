...
import type { SessionBindingRecord } from "velaclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "velaclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "velaclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("velaclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("velaclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("velaclaw/plugin-sdk/config-runtime").VelaclawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
