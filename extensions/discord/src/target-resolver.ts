import type { DirectoryConfigParams } from "velaclaw/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "velaclaw/plugin-sdk/messaging-targets";
