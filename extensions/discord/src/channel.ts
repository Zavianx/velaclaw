...
} from "velaclaw/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "velaclaw/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "velaclaw/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "velaclaw/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "velaclaw/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "velaclaw/plugin-sdk/channel-policy";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "velaclaw/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "velaclaw/plugin-sdk/error-runtime";
import { createLazyRuntimeModule } from "velaclaw/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "velaclaw/plugin-sdk/outbound-runtime";
import { sleepWithAbort } from "velaclaw/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "velaclaw/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "velaclaw/plugin-sdk/target-resolver-runtime";
import {
...
function resolveDiscordStartupDelayMs(cfg: VelaclawConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). Velaclaw adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
