...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("velaclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("velaclaw.discord.modalEntries");
