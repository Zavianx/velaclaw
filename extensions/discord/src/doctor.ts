...
import { collectProviderDangerousNameMatchingScopes } from "velaclaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: VelaclawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: VelaclawConfig,
  doctorFixCommand: string,
): { config: VelaclawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: VelaclawConfig): string[] {
