...
import { recordChannelActivity } from "velaclaw/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "velaclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "velaclaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "velaclaw/plugin-sdk/media-runtime";
import type { PollInput } from "velaclaw/plugin-sdk/media-runtime";
import { resolveChunkMode } from "velaclaw/plugin-sdk/reply-chunking";
import type { RetryConfig } from "velaclaw/plugin-sdk/retry-runtime";
import { resolvePreferredVelaclawTmpDir } from "velaclaw/plugin-sdk/temp-path";
import { convertMarkdownTables, normalizeOptionalString } from "velaclaw/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "velaclaw/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredVelaclawTmpDir();
