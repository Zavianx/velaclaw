import type { VelaclawPluginApi } from "velaclaw/plugin-sdk/channel-plugin-common";
import {
...
function resolveThreadBindingFlags(api: VelaclawPluginApi, accountId?: string) {
...
export function registerDiscordSubagentHooks(api: VelaclawPluginApi) {
