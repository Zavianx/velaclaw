...
} from "velaclaw/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "velaclaw/plugin-sdk/global-singleton";
import { createAsyncLock } from "velaclaw/plugin-sdk/infra-runtime";
import { resolveStateDir } from "velaclaw/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- velaclaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- velaclaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "velaclaw:dreaming:backfill-entry";
const DREAMS_FILE_LOCKS_KEY = Symbol.for("velaclaw.memoryCore.dreamingNarrative.fileLocks");
