...
import {
  ...
  sessionPathForFile,
} from "velaclaw/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "velaclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__velaclaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__velaclaw_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- velaclaw:dreaming:light:start -->",
    endMarker: "<!-- velaclaw:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- velaclaw:dreaming:rem:start -->",
    endMarker: "<!-- velaclaw:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: VelaclawPluginApi): void {
