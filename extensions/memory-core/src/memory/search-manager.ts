...
import { checkQmdBinaryAvailability } from "velaclaw/plugin-sdk/memory-core-host-engine-qmd";
import {
...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("velaclaw.memorySearchManagerCache");
