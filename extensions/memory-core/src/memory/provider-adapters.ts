...
import { resolveUserPath } from "velaclaw/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "velaclaw/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Velaclaw (this should install node-llama-cpp): npm i -g velaclaw@latest"
      : null,
