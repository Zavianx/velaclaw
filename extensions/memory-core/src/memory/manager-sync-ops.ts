...
} from "velaclaw/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: VelaclawConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        process.env.VELACLAW_TEST_FAST === "1" &&
        process.env.VELACLAW_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
