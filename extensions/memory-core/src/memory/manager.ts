...
import { extractKeywords } from "velaclaw/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("velaclaw.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: VelaclawConfig;
