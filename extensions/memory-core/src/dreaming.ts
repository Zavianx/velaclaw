import { peekSystemEventEntries } from "velaclaw/plugin-sdk/infra-runtime";
import type { VelaclawConfig, VelaclawPluginApi } from "velaclaw/plugin-sdk/memory-core";
import {
...
} from "velaclaw/plugin-sdk/memory-core-host-status";
...
const DREAMING_SYSTEM_EVENT_TEXT = "__velaclaw_memory_core_short_term_promotion_dream__";
...
function resolveStartupConfigFromEvent(event: unknown, fallback: VelaclawConfig): VelaclawConfig {
  ...
  return startupCfg as VelaclawConfig;
}
...
export function registerShortTermPromotionDreaming(api: VelaclawPluginApi): void {
