...
import { buildApiKeyCredential } from "velaclaw/plugin-sdk/provider-auth";
import {
  ...
  register(api: VelaclawPluginApi) {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "velaclaw configure". ' +
        "See: https://docs.velaclaw.ai/providers/ollama",
    });
  },
});
