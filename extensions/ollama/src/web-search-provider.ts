...
import { resolveEnvApiKey } from "velaclaw/plugin-sdk/provider-auth-runtime";
import {
...
} from "velaclaw/plugin-sdk/provider-web-search";
...
function resolveOllamaWebSearchApiKey(config?: VelaclawConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: VelaclawConfig): string {
...
export function createOllamaWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.velaclaw.ai/tools/web",
    autoDetectOrder: 110,
    credentialPath: "",
