export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "velaclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "velaclaw/plugin-sdk/reply-runtime";
