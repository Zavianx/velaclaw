...
import { buildDmGroupAccountAllowlistAdapter } from "velaclaw/plugin-sdk/allowlist-config-edit";
import { createChatChannelPlugin, type ChannelPlugin } from "velaclaw/plugin-sdk/channel-core";
