...
import { resolveOAuthDir } from "velaclaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: VelaclawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: VelaclawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: VelaclawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: VelaclawConfig): ResolvedWhatsAppAccount[] {
