...
import { resolvePreferredVelaclawTmpDir, type VelaclawPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: VelaclawPluginApi): void {
  ...
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredVelaclawTmpDir(), "velaclaw-diffs"),
    logger: api.logger,
  });
