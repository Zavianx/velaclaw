...
import type { AnyAgentTool, VelaclawPluginApi, VelaclawPluginToolContext } from "../api.js";
...
export function createDiffsTool(params: {
  ...
  context?: VelaclawPluginToolContext;
}): AnyAgentTool {
  return {
    name: "diffs",
    label: "Diffs",
...
function buildArtifactContext(
  context: VelaclawPluginToolContext | undefined,
