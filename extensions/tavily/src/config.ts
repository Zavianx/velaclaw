...
export function resolveTavilySearchConfig(cfg?: VelaclawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: VelaclawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: VelaclawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
