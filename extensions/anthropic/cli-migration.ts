...
type AgentDefaultsModel = NonNullable<NonNullable<VelaclawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<VelaclawConfig["agents"]>["defaults"]>["models"];
