...
import type { ChannelSetupAdapter } from "velaclaw/plugin-sdk/setup-runtime";
import {
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://velaclaw.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("velaclaw logs --follow")}\` (safest)`,
