import { DEFAULT_ACCOUNT_ID } from "velaclaw/plugin-sdk/account-id";
import {
  buildDmGroupAccountAllowlistAdapter,
  createNestedAllowlistOverrideResolver,
} from "velaclaw/plugin-sdk/allowlist-config-edit";
import type { ChannelMessageActionAdapter } from "velaclaw/plugin-sdk/channel-contract";
import { clearAccountEntryFields, createChatChannelPlugin } from "velaclaw/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "velaclaw/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "velaclaw/plugin-sdk/channel-policy";
import { attachChannelToResult } from "velaclaw/plugin-sdk/channel-send-result";
import {
...
import { createChannelDirectoryAdapter } from "velaclaw/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "velaclaw/plugin-sdk/error-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "velaclaw/plugin-sdk/outbound-runtime";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as VelaclawConfig;
