import { resolveNormalizedAccountEntry } from "velaclaw/plugin-sdk/account-core";
import { normalizeAccountId } from "velaclaw/plugin-sdk/account-id";
...
import { createChannelPluginBase, type ChannelPlugin } from "velaclaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "velaclaw/plugin-sdk/channel-plugin-common";
import type { VelaclawConfig } from "velaclaw/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "velaclaw/plugin-sdk/routing";
 ...
 *
 * See: https://github.com/Zavianx/velaclaw-dev/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: VelaclawConfig, accountId: string): boolean {
