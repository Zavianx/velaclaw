...
import type { ChannelGroupPolicy } from "velaclaw/plugin-sdk/config-runtime";
import type {
  ReplyToMode,
...
import { getRuntimeConfigSnapshot } from "velaclaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "velaclaw/plugin-sdk/runtime-env";
import { getChildLogger } from "velaclaw/plugin-sdk/runtime-env";
import type { RuntimeEnv } from "velaclaw/plugin-sdk/runtime-env";
import { normalizeLowercaseStringOrEmpty } from "velaclaw/plugin-sdk/text-runtime";
...
type TelegramChunkMode = ReturnType<
  typeof import("velaclaw/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("velaclaw/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): VelaclawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: VelaclawConfig): TelegramAccountConfig => {
    try {
