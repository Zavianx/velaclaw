...
import type { BaseTokenResolution } from "velaclaw/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "velaclaw/plugin-sdk/channel-core";
import type { VelaclawConfig } from "velaclaw/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "velaclaw/plugin-sdk/config-runtime";
import { resolveDefaultSecretProviderAlias } from "velaclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "velaclaw/plugin-sdk/routing";
import {
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<VelaclawConfig, "secrets">;
  provider: string;
  id: string;
