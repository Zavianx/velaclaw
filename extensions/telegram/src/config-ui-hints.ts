import type { ChannelConfigUiHint } from "velaclaw/plugin-sdk/channel-core";
...
export const telegramChannelConfigUiHints = {
  ...
  execApprovals: {
    ...
    help: "Telegram-native exec approval routing and approver authorization. When unset, Velaclaw auto-enables DM-first native approvals if approvers can be resolved for the selected bot account.",
  },
  ...
  "execApprovals.approvers": {
    ...
    help: "Telegram user IDs allowed to approve exec requests for this bot account. Use numeric Telegram user IDs. If you leave this unset, Velaclaw falls back to numeric owner IDs inferred from channels.telegram.allowFrom and direct-message defaultTo when possible.",
  },
