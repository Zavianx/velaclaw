...
export function shouldShowTelegramDmAccessWarning(cfg: VelaclawConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`velaclaw config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`velaclaw config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
