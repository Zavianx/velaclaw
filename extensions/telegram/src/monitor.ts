...
import { resolveAgentMaxConcurrent } from "velaclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "velaclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: VelaclawConfig): RunOptions<unknown> {
  return {
    sink: {
