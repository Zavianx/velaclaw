...
import type { TelegramNetworkConfig } from "velaclaw/plugin-sdk/config-runtime";
import { isTruthyEnvValue, isWSL2Sync } from "velaclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "velaclaw/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "VELACLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "VELACLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "VELACLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable VELACLAW_TELEGRAM_DNS_RESULT_ORDER
