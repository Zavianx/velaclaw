...
import { createFinalizableDraftLifecycle } from "velaclaw/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("velaclaw.telegramDraftStreamState");
