import { resolveAccountWithDefaultFallback } from "velaclaw/plugin-sdk/account-core";
...
import { coerceSecretRef } from "velaclaw/plugin-sdk/config-runtime";
...
function inspectTokenValue(params: { cfg: VelaclawConfig; value: unknown }): {
  token: string;
