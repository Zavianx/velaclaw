...
import {
  ...
  type VelaclawConfig,
} from "velaclaw/plugin-sdk/account-core";
import type {
...
import { formatSetExplicitDefaultInstruction } from "velaclaw/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "velaclaw/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.VELACLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: VelaclawConfig): string[] {
...
export function listTelegramAccountIds(cfg: VelaclawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: VelaclawConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/Zavianx/velaclaw-dev/issues/30673
...
export function listEnabledTelegramAccounts(cfg: VelaclawConfig): ResolvedTelegramAccount[] {
