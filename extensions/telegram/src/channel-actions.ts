...
import type { TelegramActionConfig } from "velaclaw/plugin-sdk/config-runtime";
import { readStringValue } from "velaclaw/plugin-sdk/text-runtime";
import { extractToolSend } from "velaclaw/plugin-sdk/tool-send";
import {
