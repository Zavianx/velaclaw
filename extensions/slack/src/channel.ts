...
import { buildPassiveProbedChannelStatusSummary } from "velaclaw/plugin-sdk/extension-shared";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as VelaclawConfig, toolContext as SlackActionContext | undefined),
    }),
