import { resolveGlobalDedupeCache } from "velaclaw/plugin-sdk/infra-runtime";
 ...
 */
const SLACK_THREAD_PARTICIPATION_KEY = Symbol.for("velaclaw.slackThreadParticipation");
