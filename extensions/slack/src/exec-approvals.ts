...
import { doesApprovalRequestMatchChannelAccount } from "velaclaw/plugin-sdk/approval-native-runtime";
import type { VelaclawConfig } from "velaclaw/plugin-sdk/config-runtime";
import { normalizeStringifiedOptionalString } from "velaclaw/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: VelaclawConfig): string[] {
