...
import type { DmPolicy, GroupPolicy } from "velaclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "velaclaw/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "velaclaw/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("velaclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
