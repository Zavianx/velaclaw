...
import { type ChatCommandDefinition, type CommandArgs } from "velaclaw/plugin-sdk/command-auth";
import {
...
import { chunkItems, normalizeLowercaseStringOrEmpty } from "velaclaw/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "velaclaw_cmdarg";
const SLACK_COMMAND_ARG_ACTION_LISTENER = /^velaclaw_cmdarg/;
