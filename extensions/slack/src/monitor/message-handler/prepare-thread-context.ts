import { formatInboundEnvelope } from "velaclaw/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "velaclaw/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("velaclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
