...
import { buildOauthProviderAuthResult } from "velaclaw/plugin-sdk/provider-auth-result";
import { buildProviderToolCompatFamilyHooks } from "velaclaw/plugin-sdk/provider-tools";
import { fetchGeminiUsage } from "velaclaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: VelaclawPluginApi) {
