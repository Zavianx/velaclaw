...
import { buildPluginConfigSchema, z, type VelaclawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: VelaclawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".velaclaw", "wiki", "main");
}
