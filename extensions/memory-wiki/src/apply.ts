...
const GENERATED_START = "<!-- velaclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- velaclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- velaclaw:human:start -->";
const HUMAN_END = "<!-- velaclaw:human:end -->";
