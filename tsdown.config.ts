...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.VELACLAW_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.VELACLAW_BUILD_PRIVATE_QA === "1";
...
function shouldStageBundledPluginRuntimeDependencies(packageJson: unknown): boolean {
  return (
    ...
    packageJson !== null &&
    (packageJson as { velaclaw?: { bundle?: { stageRuntimeDependencies?: boolean } } }).velaclaw
...
function isPluginSdkSelfReference(id: string): boolean {
  return (
    id === "velaclaw/plugin-sdk" ||
    id.startsWith("velaclaw/plugin-sdk/") ||
    id === "@velaclaw/plugin-sdk" ||
    id.startsWith("@velaclaw/plugin-sdk/")
  );
}
