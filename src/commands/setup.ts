...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: VelaclawConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: VelaclawConfig): Promise<void> {
