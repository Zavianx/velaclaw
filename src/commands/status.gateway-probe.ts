...
export async function resolveGatewayProbeAuthResolution(cfg: VelaclawConfig): Promise<{
  auth: {
    token?: string;
    password?: string;
  };
...
export async function resolveGatewayProbeAuth(cfg: VelaclawConfig): Promise<{
  token?: string;
  password?: string;
}> {
