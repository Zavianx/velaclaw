...
import { replaceConfigFile, type VelaclawConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: VelaclawConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as VelaclawConfig;
  ...
  // May trigger loadVelaclawPlugins on cache miss (disk scan + jiti import)
