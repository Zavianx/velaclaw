...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.velaclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("velaclaw hooks list")}`,
      `  ${formatCliCommand("velaclaw hooks enable <name>")}`,
      `  ${formatCliCommand("velaclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
