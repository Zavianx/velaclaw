...
function resolveDefaultAccountId(cfg: VelaclawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: VelaclawConfig): boolean {
...
export function summarizeBindings(cfg: VelaclawConfig, bindings: AgentBinding[]): string[] {
