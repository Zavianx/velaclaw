...
function collectExecSafeBinScopes(cfg: VelaclawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: VelaclawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: VelaclawConfig): {
