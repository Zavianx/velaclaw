...
export function collectMissingDefaultAccountBindingWarnings(cfg: VelaclawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: VelaclawConfig): string[] {
  const warnings: string[] = [];
