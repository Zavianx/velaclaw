...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set VELACLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `velaclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Velaclaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
