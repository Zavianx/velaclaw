...
type ConsoleConfigLoader = () => VelaclawConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.VELACLAW_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.VELACLAW_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
