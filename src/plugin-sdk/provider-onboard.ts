...
export type { VelaclawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: VelaclawConfig, ...args: TArgs) => VelaclawConfig;
  applyConfig: (cfg: VelaclawConfig, ...args: TArgs) => VelaclawConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: VelaclawConfig, preset: TParams) => VelaclawConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: VelaclawConfig): {
  next: VelaclawConfig;
  changed: boolean;
} {
