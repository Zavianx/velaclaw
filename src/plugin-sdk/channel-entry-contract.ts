...
import type { AnyAgentTool, VelaclawPluginApi, PluginCommandContext } from "../plugins/types.js";
import { normalizeLowercaseStringOrEmpty } from "../shared/string-coerce.js";

export type { AnyAgentTool, VelaclawPluginApi, PluginCommandContext };
...
type DefineBundledChannelEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: VelaclawPluginApi) => void;
  registerFull?: (api: VelaclawPluginApi) => void;
};
...
const disableBundledEntrySourceFallbackEnv = "VELACLAW_DISABLE_BUNDLED_ENTRY_SOURCE_FALLBACK";
