...
let cachedVelaclawPackageRoot: string | undefined;
...
function getVelaclawPackageRoot() {
  if (cachedVelaclawPackageRoot) {
    return cachedVelaclawPackageRoot;
  }
  cachedVelaclawPackageRoot =
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  if (preferSource) {
    const modulePath =
      resolveBundledPluginSourcePublicSurfacePath({
        ...params,
        sourceRoot: bundledPluginsDir ?? path.resolve(getVelaclawPackageRoot(), "extensions"),
      }) ??
      resolveBundledPluginPublicSurfacePath({
        rootDir: getVelaclawPackageRoot(),
        env: params.env,
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      params.location.boundaryRoot === getVelaclawPackageRoot()
        ? "Velaclaw package root"
        : (() => {
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedVelaclawPackageRoot = undefined;
}
