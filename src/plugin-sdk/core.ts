...
import type { VelaclawPluginApi } from "../plugins/types.js";
...
export type { VelaclawPluginToolContext, VelaclawPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: VelaclawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
