...
export function isAcpEnabledByPolicy(cfg: VelaclawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: VelaclawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: VelaclawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: VelaclawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: VelaclawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: VelaclawConfig, agentId: string): boolean {
