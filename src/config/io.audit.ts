...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.VELACLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.VELACLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.VELACLAW_WATCH_COMMAND),
