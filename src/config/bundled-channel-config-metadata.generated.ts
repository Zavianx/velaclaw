...
export const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = [
  ...
  },
  {
    ...
    uiHints: {
      "": {
        label: "IRC",
        help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into Velaclaw.",
      },
      dmPolicy: {
        label: "IRC DM Policy",
  ...
  },
  {
    ...
    label: "QA Channel",
    description: "Synthetic Slack-class transport for automated Velaclaw QA scenarios.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
  ...
  },
  {
    ...
    label: "Synology Chat",
    description: "Connect your Synology NAS Chat to Velaclaw with full agent capabilities.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
