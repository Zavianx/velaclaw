...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "velaclaw.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.velaclaw/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/velaclaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__velaclaw__/canvas or /__velaclaw__/a2ui content.
   */
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/Zavianx/velaclaw-dev/issues/47711
   */
