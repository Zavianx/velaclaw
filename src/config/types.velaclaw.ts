...
import type { PersonalTeamConfig } from "./types.personal-team.js";
...
export type VelaclawConfig = {
  meta?: {
    /** Last Velaclaw version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Velaclaw UI chrome (hex). */
    seamColor?: string;
    assistant?: {
  ...
  agents?: AgentsConfig;
  personalTeam?: PersonalTeamConfig;
  tools?: ToolsConfig;
...
declare const velaClawConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = VelaclawConfig & {
  readonly [velaClawConfigStateBrand]?: TState;
};
