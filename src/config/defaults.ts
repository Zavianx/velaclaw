...
export function applyMessageDefaults(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyTalkConfigNormalization(config: VelaclawConfig): VelaclawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: VelaclawConfig): VelaclawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyLoggingDefaults(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyContextPruningDefaults(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyCompactionDefaults(cfg: VelaclawConfig): VelaclawConfig {
