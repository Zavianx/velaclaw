...
function resolveRealtimeVoiceProviderEntries(cfg?: VelaclawConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: VelaclawConfig): RealtimeVoiceProviderPlugin[] {
