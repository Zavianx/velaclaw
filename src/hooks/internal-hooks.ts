/**
 * Hook system for Velaclaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("velaclaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("velaclaw.internalHooksEnabled");
