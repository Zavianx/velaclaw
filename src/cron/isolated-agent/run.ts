...
function hasConfiguredAuthProfiles(cfg: VelaclawConfig): boolean {
  return (
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: VelaclawConfig = {
    ...input.cfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.VELACLAW_TEST_FAST === "1";
