...
type WebFetchConfig = NonNullable<VelaclawConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(config: VelaclawConfig | undefined): WebFetchConfig | undefined {
