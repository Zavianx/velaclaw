...
export function listBindings(cfg: VelaclawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: VelaclawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: VelaclawConfig) {
