...
export function listAuthProfileStorePaths(config: VelaclawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: VelaclawConfig, stateDir: string): string[] {
