...
type PluginEntriesConfig = NonNullable<NonNullable<VelaclawConfig["plugins"]>["entries"]>;
...
// VELACLAW_API_KEY authenticates the local Velaclaw bridge itself and must
