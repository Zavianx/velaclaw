...
function resolveResolutionLimits(config: VelaclawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: VelaclawConfig): SecretProviderConfig {
