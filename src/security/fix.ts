...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof VelaclawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: VelaclawConfig; env: NodeJS.ProcessEnv }): {
  cfg: VelaclawConfig;
  changes: string[];
} {
