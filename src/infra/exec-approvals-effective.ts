...
const DEFAULT_HOST_PATH = "~/.velaclaw/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `Velaclaw default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `Velaclaw default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
