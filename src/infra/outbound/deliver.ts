import { sendMediaWithLeadingCaption } from "velaclaw/plugin-sdk/reply-payload";
import {
  chunkByParagraph,
...
function createChannelOutboundContextBase(
  ...
  return {
    ...
    mediaLocalRoots: getOutboundMediaAccessLocalRoots(params.mediaAccess),
    mediaReadFile: getOutboundMediaAccessReadFile(params.mediaAccess),
