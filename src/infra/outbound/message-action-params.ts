...
export function resolveAttachmentMediaPolicy(params: {
  ...
  const accessReadFile = getOutboundMediaAccessReadFile(params.mediaAccess);
  return {
    mode: "host",
    mediaAccess: resolveOutboundMediaAccess({
      mediaAccess: params.mediaAccess,
      mediaLocalRoots: explicitLocalRoots,
      mediaReadFile: accessReadFile ? undefined : params.mediaReadFile,
    }),
    ...(explicitLocalRoots.length ? { mediaLocalRoots: explicitLocalRoots } : {}),
    ...(accessReadFile
      ? {}
