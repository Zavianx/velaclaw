...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("velaclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("velaclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: VelaclawConfig): Promise<ContextEngine> {
