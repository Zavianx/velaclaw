...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.velaclaw/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "velaclaw doctor" and "velaclaw approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
