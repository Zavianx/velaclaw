...
import {
  collectPresentVelaclawTools,
  isUpdatePlanToolEnabledForVelaclawTools,
} from "./velaclaw-tools.registration.js";
import { resolveWorkspaceRoot } from "./workspace-dir.js";

type VelaclawToolsDeps = {
  callGateway: typeof callGateway;
  config?: VelaclawConfig;
};

const defaultVelaclawToolsDeps: VelaclawToolsDeps = {
  callGateway,
};

let velaClawToolsDeps: VelaclawToolsDeps = defaultVelaclawToolsDeps;

export function createVelaclawTools(
  options?: {
  ...
  const resolvedConfig = options?.config ?? velaClawToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    createSessionsListTool({
      ...
      sandboxed: options?.sandboxed,
      config: resolvedConfig,
      callGateway: velaClawToolsDeps.callGateway,
    }),
  ...
  const wrappedPluginTools = resolveVelaclawPluginToolsForOptions({
    options,
    resolvedConfig,
...
export const __testing = {
  setDepsForTest(overrides?: Partial<VelaclawToolsDeps>) {
    velaClawToolsDeps = overrides
      ? {
          ...defaultVelaclawToolsDeps,
          ...overrides,
        }
      : defaultVelaclawToolsDeps;
  },
