...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "velaclaw:bootstrap-context:full";

export function resolveContextInjectionMode(config?: VelaclawConfig): AgentContextInjection {
