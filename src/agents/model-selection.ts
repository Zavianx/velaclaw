...
function resolveAllowedFallbacks(params: { cfg: VelaclawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: VelaclawConfig }): ModelCatalogEntry[] {
