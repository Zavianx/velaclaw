...
const CLEANUP_STATE_KEY = Symbol.for("velaclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("velaclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("velaclaw.sessionWriteLockWatchdogState");
