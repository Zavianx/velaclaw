...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "velaclaw-openai-responses-transport",
  "openai-codex-responses": "velaclaw-openai-responses-transport",
  "openai-completions": "velaclaw-openai-completions-transport",
  "azure-openai-responses": "velaclaw-azure-openai-responses-transport",
  "anthropic-messages": "velaclaw-anthropic-messages-transport",
  "google-generative-ai": "velaclaw-google-generative-ai-transport",
};
