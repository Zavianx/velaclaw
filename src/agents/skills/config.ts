...
export function isConfigPathTruthy(config: VelaclawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["velaclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: VelaclawConfig): string[] | undefined {
