...
export function resolveSubagentToolPolicy(cfg?: VelaclawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: VelaclawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: VelaclawConfig["tools"];
