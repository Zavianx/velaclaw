...
export const DEFAULT_SANDBOX_IMAGE = "velaclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "velaclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "velaclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "velaclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "velaclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "velaclaw-sandbox-browser";
