...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: VelaclawConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: VelaclawConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: VelaclawConfig, runTimeoutSeconds?: number) {
