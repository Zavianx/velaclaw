...
export function resolveSessionToolsVisibility(cfg: VelaclawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: VelaclawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: VelaclawConfig): AgentToAgentPolicy {
