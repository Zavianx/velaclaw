...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<VelaclawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<VelaclawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: VelaclawConfig): WebSearchConfig {
