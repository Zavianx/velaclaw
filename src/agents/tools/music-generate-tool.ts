...
function validateMusicGenerationCapabilities(params: {
  ...
  if (params.inputImageCount > 0) {
    ...
    const maxInputImages = (caps as { maxInputImages?: number }).maxInputImages ?? MAX_INPUT_IMAGES;
...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under Velaclaw-managed media storage and delivered automatically as attachments.",
