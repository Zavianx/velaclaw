...
export const createVelaclawCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createVelaclawCodingToolsMock.mockReset();
  createVelaclawCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureVelaclawModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveVelaclawDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createVelaclawCodingTools: createVelaclawCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveVelaclawAgentDir: vi.fn(() => "/tmp"),
  }));
