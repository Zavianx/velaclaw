...
import { ensureVelaclawModelsJson } from "../models-config.js";
...
import { createVelaclawCodingTools } from "../pi-tools.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureVelaclawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createVelaclawCodingTools({
      exec: {
