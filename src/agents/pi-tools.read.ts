...
function resolveAdaptiveReadMaxBytes(options?: VelaclawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createVelaclawReadTool(base, {
...
export function createVelaclawReadTool(
  base: AnyAgentTool,
  options?: VelaclawReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
