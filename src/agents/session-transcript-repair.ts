...
const REDACTED_SESSIONS_SPAWN_ATTACHMENT_CONTENT = "__VELACLAW_REDACTED__";
...
function makeMissingToolResult(params: {
  ...
  return {
    ...
    content: [
      {
        type: "text",
        text: "[velaclaw] missing tool result in session history; inserted synthetic error result for transcript repair.",
      },
    ],
    isError: true,
    timestamp: Date.now(),
