/**
 * Standalone MCP server that exposes Velaclaw plugin-registered tools
...
function resolveTools(config: VelaclawConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "velaclaw-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
