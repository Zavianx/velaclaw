...
export function buildBuiltinChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "claw",
      nativeName: "claw",
      description: "Create, switch, leave, list, edit, or remove named claws.",
      textAlias: "/claw",
      category: "session",
      args: [
        {
          name: "action",
          description: "create | use | leave | list | current | edit | remove",
          type: "string",
          choices: [
            "create",
            "new",
    ...
    defineChatCommand({
      key: "mcp",
      nativeName: "mcp",
      description: "Show or set Velaclaw MCP servers.",
      textAlias: "/mcp",
      category: "management",
      args: [
        {
