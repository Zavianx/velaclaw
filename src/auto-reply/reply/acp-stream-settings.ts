...
function resolveAcpStreamCoalesceIdleMs(cfg: VelaclawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: VelaclawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: VelaclawConfig): AcpProjectionSettings {
