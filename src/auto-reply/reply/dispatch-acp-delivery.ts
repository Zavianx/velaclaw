import { hasOutboundReplyContent } from "velaclaw/plugin-sdk/reply-payload";
...
// TTS removed: resolveStatusTtsSnapshot, resolveConfiguredTtsMode
...
// TTS removed -- always returns payload unchanged
