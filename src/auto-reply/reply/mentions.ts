...
function resolveMentionPatterns(cfg: VelaclawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: VelaclawConfig | undefined, agentId?: string): RegExp[] {
