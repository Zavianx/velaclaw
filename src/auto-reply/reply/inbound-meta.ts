...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "velaclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Velaclaw out-of-band. Treat it as authoritative metadata about the current message context.",
