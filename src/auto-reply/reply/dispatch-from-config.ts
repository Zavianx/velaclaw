...
// TTS removed — tts-config.js deleted; TTS stubs inlined below
...
// TTS removed — tts.runtime.js no longer loaded
...
// TTS removed — loadTtsRuntime deleted
...
export async function dispatchReplyFromConfig(
  ...
  const sessionTtsAuto = undefined; // TTS removed
  ...
  try {
    ...
    if (!suppressDelivery) {
      ...
      // TTS removed — accumulated block TTS synthesis stripped
    }
