...
import { getRuntimeConfigSnapshot, type VelaclawConfig } from "../../config/config.js";
import {
...
export function resolveQueuedReplyRuntimeConfig(config: VelaclawConfig): VelaclawConfig {
  return (
