...
// TTS removed — status-config.js and tts-config.js deleted
...
> | null = null;
// TTS removed — dispatch-acp-tts.runtime.js no longer loaded
...
async function finalizeAcpTurnOutput(params: {
  ...
  // TTS removed — skip TTS synthesis, only deliver text fallback when needed
