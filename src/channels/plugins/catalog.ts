...
import type { VelaclawPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["VELACLAW_PLUGIN_CATALOG_PATHS", "VELACLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<VelaclawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
