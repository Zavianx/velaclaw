...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: VelaclawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: VelaclawConfig }>(
  collector: WarningCollector<{ cfg: VelaclawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: VelaclawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: VelaclawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: VelaclawConfig },
>(
  projectCfg: (cfg: VelaclawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: VelaclawConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: VelaclawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: VelaclawConfig },
>(params: {
  providerConfigPresent: (cfg: VelaclawConfig) => boolean;
