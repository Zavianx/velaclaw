...
export function createMessageActionDiscoveryContext(
  ...
  return {
    cfg: params.cfg ?? ({} as VelaclawConfig),
...
export function listChannelMessageActions(cfg: VelaclawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: VelaclawConfig): ChannelMessageCapability[] {
