...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: VelaclawConfig): string | undefined {
  ...
  function listAccountIds(cfg: VelaclawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: VelaclawConfig): string {
