...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: VelaclawConfig) => string[];
  resolveAccount: (cfg: VelaclawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: VelaclawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: VelaclawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: VelaclawConfig;
    accountId: string;
    enabled: boolean;
  }) => VelaclawConfig;
  deleteAccount?: (params: { cfg: VelaclawConfig; accountId: string }) => VelaclawConfig;
  isEnabled?: BivariantCallback<(account: ResolvedAccount, cfg: VelaclawConfig) => boolean>;
  disabledReason?: BivariantCallback<(account: ResolvedAccount, cfg: VelaclawConfig) => string>;
  isConfigured?: BivariantCallback<
    (account: ResolvedAccount, cfg: VelaclawConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: VelaclawConfig) => string>;
  describeAccount?: BivariantCallback<
    (account: ResolvedAccount, cfg: VelaclawConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: VelaclawConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: VelaclawConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: BivariantCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: VelaclawConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.velaclaw.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: VelaclawConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: VelaclawConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: VelaclawConfig;
    nextCfg: VelaclawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: VelaclawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: VelaclawConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: VelaclawConfig; accountId?: string | null }) =>
    | {
