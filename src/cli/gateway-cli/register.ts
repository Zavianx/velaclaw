      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["velaclaw gateway run", "Run the gateway in the foreground."],
            ["velaclaw gateway status", "Show service status and probe reachability."],
            ["velaclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["velaclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.velaclaw.ai/cli/gateway")}\n`,
      ),
  );
