    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["velaclaw directory self --channel slack", "Show the connected account identity."],
          [
            'velaclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["velaclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "velaclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.velaclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
