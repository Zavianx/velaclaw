    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["velaclaw channels list", "List configured channels and auth profiles."],
          ["velaclaw channels status --probe", "Run channel status checks and probes."],
          [
            "velaclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["velaclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.velaclaw.ai/cli/channels",
        )}\n`,
    );
