...
import { serveVelaclawChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Velaclaw MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Velaclaw channels over MCP stdio")
