...
const SANDBOX_EXAMPLES = {
  main: [
    ["velaclaw sandbox list", "List all sandbox containers."],
    ["velaclaw sandbox list --browser", "List only browser containers."],
    ["velaclaw sandbox recreate --all", "Recreate all containers."],
    ["velaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["velaclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["velaclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["velaclaw sandbox list", "List all sandbox containers."],
    ["velaclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["velaclaw sandbox recreate --all", "Recreate all containers."],
    ["velaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["velaclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["velaclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["velaclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["velaclaw sandbox explain", "Show effective sandbox config."],
    ["velaclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["velaclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["velaclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.velaclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
