...
import { readBestEffortConfig, type VelaclawConfig } from "../config/config.js";
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.velaclaw.ai/cli/approvals")}\n`,
    );
