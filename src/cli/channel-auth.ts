...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: VelaclawConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: VelaclawConfig, mode: ChannelAuthMode): string {
