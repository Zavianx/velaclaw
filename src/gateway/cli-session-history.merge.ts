...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__velaclaw" in message &&
    (message as { __velaclaw?: unknown }).__velaclaw &&
    typeof (message as { __velaclaw?: unknown }).__velaclaw === "object"
      ? ((message as { __velaclaw?: Record<string, unknown> }).__velaclaw ?? {})
      : undefined;
