...
export function collectConfiguredModelPricingRefs(config: VelaclawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: VelaclawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
