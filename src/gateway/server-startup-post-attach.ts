...
import { resolveVelaclawAgentDir } from "../agents/agent-paths.js";
...
import { ensureVelaclawModelsJson } from "../agents/models-config.js";
...
import type { loadVelaclawPlugins } from "../plugins/loader.js";
...
async function prewarmConfiguredPrimaryModel(params: {
  ...
  try {
    await ensureVelaclawModelsJson(params.cfg, agentDir);
...
export async function startGatewaySidecars(params: {
  cfg: VelaclawConfig;
  pluginRegistry: ReturnType<typeof loadVelaclawPlugins>;
  ...
  if (!skipChannels) {
    ...
    params.logChannels.info(
      "skipping channel start (VELACLAW_SKIP_CHANNELS=1 or VELACLAW_SKIP_PROVIDERS=1)",
    );
  }
...
export async function startGatewayPostAttachRuntime(
  params: {
    ...
    gatewayPluginConfigAtStart: VelaclawConfig;
    pluginRegistry: ReturnType<typeof loadVelaclawPlugins>;
    defaultWorkspaceDir: string;
    deps: CliDeps;
    startChannels: () => Promise<void>;
