...
export function resolveGatewayReloadSettings(cfg: VelaclawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: VelaclawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: VelaclawConfig) => void | Promise<void>;
  ...
  let pendingInProcessConfig: VelaclawConfig | null = null;
  ...
  const queueRestart = (plan: GatewayReloadPlan, nextConfig: VelaclawConfig) => {
    if (restartQueued) {
      return;
    }
    restartQueued = true;
  ...
  const applySnapshot = async (nextConfig: VelaclawConfig) => {
