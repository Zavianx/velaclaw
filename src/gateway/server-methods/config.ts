...
import type { ConfigValidationIssue, VelaclawConfig } from "../../config/types.velaclaw.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: VelaclawConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: VelaclawConfig, next: VelaclawConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadVelaclawPlugins() (called inside
