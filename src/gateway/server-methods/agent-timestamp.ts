 ...
 *
 * @see https://github.com/Zavianx/velaclaw-dev/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an VelaclawConfig.
 */
export function timestampOptsFromConfig(cfg: VelaclawConfig): TimestampInjectionOptions {
  return {
