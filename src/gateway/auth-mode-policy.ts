...
export function hasAmbiguousGatewayAuthModeConfig(cfg: VelaclawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: VelaclawConfig): void {
