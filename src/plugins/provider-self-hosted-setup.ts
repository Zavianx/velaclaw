...
export function applyProviderDefaultModel(cfg: VelaclawConfig, modelRef: string): VelaclawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: VelaclawConfig; modelId: string; modelRef: string; profileId: string } {
