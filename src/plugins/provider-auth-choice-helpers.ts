...
export function applyProviderAuthConfigPatch(cfg: VelaclawConfig, patch: unknown): VelaclawConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<VelaclawConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: VelaclawConfig, model: string): VelaclawConfig {
