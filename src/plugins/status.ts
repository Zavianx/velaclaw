...
import { normalizeVelaclawVersionBase } from "../config/version.js";
...
import { loadVelaclawPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeVelaclawVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeVelaclawVersionBase(plugin.version) ??
    plugin.version
  );
}
