...
export type PluginTextTransforms = {
  ...
  /** Rewrites applied to inbound assistant text before Velaclaw consumes it. */
...
export type CliBackendPlugin = {
  ...
  /**
   * Whether Velaclaw should inject bundle MCP config for this backend.
   *
   * Keep this opt-in. Only backends that explicitly consume Velaclaw's bundle
