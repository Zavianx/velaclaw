...
import type { VelaclawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: VelaclawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): VelaclawPluginConfigSchema {
  return {
