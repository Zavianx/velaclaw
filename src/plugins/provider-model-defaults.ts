...
export function applyGoogleGeminiModelDefault(cfg: VelaclawConfig): {
  next: VelaclawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyOpenAIConfig(cfg: VelaclawConfig): VelaclawConfig {
...
export function applyOpencodeGoModelDefault(cfg: VelaclawConfig): {
  next: VelaclawConfig;
  changed: boolean;
} {
