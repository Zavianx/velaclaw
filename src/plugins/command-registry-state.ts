...
import type { VelaclawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = VelaclawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("velaclaw.pluginCommandsState");
