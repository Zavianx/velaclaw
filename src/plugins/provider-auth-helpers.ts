...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveVelaclawAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: VelaclawConfig): SecretRef {
