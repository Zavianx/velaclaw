...
// TTS removed — tts-runtime.types.js deleted
...
export type PluginRuntimeCore = {
  version: string;
  config: {
    loadConfig: () => import("../../config/types.velaclaw.js").VelaclawConfig;
    writeConfigFile: (
      cfg: import("../../config/types.velaclaw.js").VelaclawConfig,
  ...
  tts: {
    textToSpeech: (...args: unknown[]) => Promise<unknown>; // TTS removed — stub
    textToSpeechTelephony: (...args: unknown[]) => Promise<unknown>; // TTS removed — stub
    listVoices: (...args: unknown[]) => Promise<unknown[]>; // TTS removed — stub
  };
  mediaUnderstanding: {
