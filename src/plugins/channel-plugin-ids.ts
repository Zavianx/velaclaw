...
function resolveGatewayStartupDreamingPluginIds(config: VelaclawConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: VelaclawConfig): string | undefined {
