...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">velaclaw devices list</span><br />
          <span class="mono">velaclaw devices approve &lt;requestId&gt;</span>
        </div>
        <div style="margin-top: 6px; font-size: 12px;">${t("overview.pairing.mobileHint")}</div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.velaclaw.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">velaclaw dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">velaclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.velaclaw.ai/web/dashboard"
              target=${EXTERNAL_LINK_TARGET}
              rel=${buildExternalLinkRel()}
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "velaclaw dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.velaclaw.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.velaclaw.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.velaclaw.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px; min-width: 0;">
                    <input
                      ...
                      placeholder="VELACLAW_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${renderConnectCommand("velaclaw gateway run")}
                  </li>
                  <li>
                    ${t("overview.connection.step2")} ${renderConnectCommand("velaclaw dashboard")}
                  </li>
                  <li>${t("overview.connection.step3")}</li>
                  <li>
                    ${t("overview.connection.step4")}<code
                      >velaclaw doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
