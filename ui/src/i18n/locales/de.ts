...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.Zavianx/velaclaw-dev.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von velaclaw dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit velaclaw models auth erneut authentifizieren",
