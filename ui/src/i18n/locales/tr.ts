...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "velaclaw.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde velaclaw dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — velaclaw models auth ile yeniden kimlik doğrulayın",
