...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.Zavianx/velaclaw-dev.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde velaclaw dashboard --no-open en tu escritorio.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con velaclaw models auth",
