...
export const pt_BR: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando velaclaw dashboard --no-open no desktop.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentique novamente com velaclaw models auth",
