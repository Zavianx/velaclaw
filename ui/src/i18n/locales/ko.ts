...
export const ko: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "모바일에서 사용 중이신가요? 데스크톱에서 velaclaw dashboard --no-open으로 전체 URL(#token=... 포함)을 복사하세요.",
    },
    insecure: {
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — velaclaw models auth로 다시 인증하세요",
