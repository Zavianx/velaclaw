...
const targetModel =
  modelIds.find((id) => id === "velaclaw/default") ?? modelIds.find((id) => id === "velaclaw");
if (!targetModel) {
  throw new Error(`velaclaw model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
