...
const codexRepo = process.env.VELACLAW_CODEX_REPO
  ? path.resolve(process.env.VELACLAW_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches Velaclaw bridge assumptions: ${schemaRoot}`,
);
