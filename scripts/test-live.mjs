...
const env = {
  ...process.env,
  VELACLAW_LIVE_TEST: process.env.VELACLAW_LIVE_TEST || "1",
  VELACLAW_LIVE_TEST_QUIET: quietOverride ?? process.env.VELACLAW_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.VELACLAW_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
