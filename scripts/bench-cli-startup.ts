...
const DEFAULT_ENTRY = "velaclaw.mjs";
...
function printUsage(): void {
  console.log(`Velaclaw CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: velaclaw.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "velaclaw-cli-bench-"));
