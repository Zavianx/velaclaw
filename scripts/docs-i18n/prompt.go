...
- Keep product names in English: Velaclaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Velaclaw Gateway, use “Gateway 网关”.
