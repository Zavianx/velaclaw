...
const ENV_PROVIDER = "VELACLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "VELACLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "VELACLAW_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "VELACLAW_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "VELACLAW_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "VELACLAW_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "VELACLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "VELACLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "Velaclaw", target: "Velaclaw" },
