...
const DISABLE_POSTINSTALL_ENV = "VELACLAW_DISABLE_BUNDLED_PLUGIN_POSTINSTALL";
...
const LEGACY_UPDATE_COMPAT_SIDECARS = [
  {
    ...
    content:
      "// Compatibility stub for older Velaclaw updaters. QA Lab is not packaged.\nexport {};\n",
  },
];
  ...
  const createTempPath =
    ...
    ((unsafeTargetPath) =>
      join(
        ...
        `.${basename(unsafeTargetPath)}.velaclaw-hotfix-${randomUUID()}`,
      ));
  const writeFile =
