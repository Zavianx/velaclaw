...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']velaclaw\/plugin-sdk["']/,
    hint: "Use velaclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']velaclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use velaclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']velaclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or velaclaw/plugin-sdk/testing for public surfaces.",
  },
  {
