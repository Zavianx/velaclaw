...
if [[ -z "$version_content" ]]; then
  echo "<h2>Velaclaw $VERSION</h2>"
  echo "<p>Latest Velaclaw update.</p>"
  echo "<p><a href=\"https://github.com/Zavianx/velaclaw-dev/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
