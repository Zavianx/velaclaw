...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "velaclaw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Velaclaw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Velaclaw Issue Label Audit");
