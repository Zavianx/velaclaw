...
# Output:
# - dist/Velaclaw.app
# - dist/Velaclaw-<version>.zip
# - dist/Velaclaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.velaclaw.mac}"
...
APP="$ROOT_DIR/dist/Velaclaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Velaclaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/Velaclaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Velaclaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Velaclaw-$VERSION.dSYM.zip"
