...
export const OPTIONAL_BUNDLED_BUILD_ENV = "VELACLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.velaclaw?.install?.npmSpec === "string" &&
    packageJson.velaclaw.install.npmSpec.trim().length > 0
  );
}
