...
show_usage() {
    cat << EOF
clawlog - Velaclaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Velaclaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Velaclaw logs flow through the macOS unified log (subsystem: ai.velaclaw).
