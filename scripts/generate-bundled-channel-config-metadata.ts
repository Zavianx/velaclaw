...
function resolvePackageChannelMeta(source: BundledPluginSource) {
  const velaclawMeta =
    ...
    "velaclaw" in source.packageJson
      ? (source.packageJson.velaclaw as Record<string, unknown> | undefined)
      : undefined;
  const channelMeta =
    velaclawMeta &&
    typeof velaclawMeta.channel === "object" &&
    velaclawMeta.channel &&
    !Array.isArray(velaclawMeta.channel)
      ? (velaclawMeta.channel as Record<string, unknown>)
      : undefined;
  return channelMeta;
}
