...
**⚠️ CRITICAL: Never review PRs in Velaclaw's own project folder!**
...
8. **NEVER start Codex inside your Velaclaw state directory** (`$VELACLAW_STATE_DIR`, default `~/.velaclaw`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/velaclaw/** - that's the LIVE Velaclaw instance!
...
For long-running background tasks, append a wake trigger to your prompt so Velaclaw gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
velaclaw system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: velaclaw system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
