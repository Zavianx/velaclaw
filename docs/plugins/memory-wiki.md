...
If the active memory plugin exposes shared recall artifacts, Velaclaw can search
...
currently exposing public bridge inputs yet. Run `velaclaw wiki doctor` first,
...
velaclaw wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
