...
summary: "Testing utilities and patterns for Velaclaw plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Velaclaw
plugins.
...
import type { PluginRuntime } from "velaclaw/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `velaclaw/plugin-sdk` root barrel is rejected
