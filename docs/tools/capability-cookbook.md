---
summary: "Contributor guide for adding a new shared capability to the Velaclaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Velaclaw core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Velaclaw needs a new domain such as image generation, video
