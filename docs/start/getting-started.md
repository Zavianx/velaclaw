---
summary: "Get VelaClaw installed and run your first chat in minutes."
read_when:
...
Install VelaClaw, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run VelaClaw as a service account or want custom paths:

- `VELACLAW_HOME` — home directory for internal path resolution
- `VELACLAW_STATE_DIR` — override the state directory
- `VELACLAW_CONFIG_PATH` — override the config file path
