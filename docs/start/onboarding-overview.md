---
summary: "Overview of VelaClaw onboarding options and flows"
read_when:
...
VelaClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `velaclaw onboard`                     | Launch the app            |
...
CLI command docs: [`velaclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the VelaClaw app. The first-run wizard walks you through the same steps
