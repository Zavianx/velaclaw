---
summary: "First-run setup flow for VelaClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give VelaClaw">
...
<Step title="CLI">
  ...
  The app can install the global `velaclaw` CLI via npm, pnpm, or bun.
