...
Script: [`scripts/bench-model.ts`](https://github.com/Zavianx/velaclaw/blob/main/scripts/bench-model.ts)
...
Script: [`scripts/bench-cli-startup.ts`](https://github.com/Zavianx/velaclaw/blob/main/scripts/bench-cli-startup.ts)
