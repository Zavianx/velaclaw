...
read_when:
  - You want to use Volcano Engine or Doubao models with Velaclaw
...
<Steps>
  <Step title="Set the API key">
    ...
    ```bash
    velaclaw onboard --auth-choice volcengine-api-key
    ```
...
<Warning>
When running Velaclaw as a background service, environment variables set in your
