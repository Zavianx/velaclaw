---
summary: "Run Velaclaw with SGLang (OpenAI-compatible self-hosted server)"
read_when:
  - You want to run Velaclaw against a local SGLang server
...
Velaclaw can connect to SGLang using the `openai-completions` API.
