---
summary: "Use xAI Grok models in Velaclaw"
read_when:
  - You want to use Grok models in Velaclaw
...
Velaclaw ships a bundled `xai` provider plugin for Grok models.
...
<Steps>
  ...
  <Step title="Set your API key">
    ...
    ```bash
    velaclaw onboard --auth-choice xai-api-key
    ```
...
<AccordionGroup>
  <Accordion title="Web search">
    ...
    ```bash
    velaclaw config set tools.web.search.provider grok
    ```
  ...
  <Accordion title="x_search configuration">
    The bundled xAI plugin exposes `x_search` as an Velaclaw tool for searching
  ...
  <Accordion title="Code execution configuration">
    The bundled xAI plugin exposes `code_execution` as an Velaclaw tool for
  ...
  <Accordion title="Advanced notes">
    - Velaclaw applies xAI-specific tool-schema and tool-call compatibility fixes
    ...
    - `web_search`, `x_search`, and `code_execution` are exposed as Velaclaw
      tools. Velaclaw enables the specific xAI built-in it needs inside each tool
