---
summary: "Use OpenCode Zen and Go catalogs with Velaclaw"
read_when:
...
OpenCode exposes two hosted catalogs in Velaclaw:
...
Both catalogs use the same OpenCode API key. Velaclaw keeps the runtime provider ids
