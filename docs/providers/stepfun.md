---
summary: "Use StepFun models with Velaclaw"
read_when:
  - You want StepFun models in Velaclaw
...
Velaclaw includes a bundled StepFun provider plugin with two provider ids:
...
<AccordionGroup>
  ...
  <Accordion title="Notes">
    - The provider is bundled with Velaclaw, so there is no separate plugin install step.
