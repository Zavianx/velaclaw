---
summary: "Use Mistral models and Voxtral transcription with Velaclaw"
read_when:
  - You want to use Mistral models in Velaclaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    velaclaw onboard --auth-choice mistral-api-key
    ```

    Or pass the key directly:

    ```bash
    velaclaw onboard --mistral-api-key "$MISTRAL_API_KEY"
    ```
...
Velaclaw currently ships this bundled Mistral catalog:
...
<AccordionGroup>
  <Accordion title="Adjustable reasoning (mistral-small-latest)">
    ...
    Velaclaw maps the session **thinking** level to Mistral's API:

    | Velaclaw thinking level                          | Mistral `reasoning_effort` |
    | ------------------------------------------------ | -------------------------- |
    | **off** / **minimal**                            | `none`                     |
