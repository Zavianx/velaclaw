...
summary: "Alibaba Model Studio Wan video generation in Velaclaw"
read_when:
  - You want to use Alibaba Wan video generation in Velaclaw
  - You need Model Studio or DashScope API key setup for video generation
---

# Alibaba Model Studio

Velaclaw ships a bundled `alibaba` video-generation provider for Wan models on
...
<AccordionGroup>
  ...
  <Accordion title="Auth key priority">
    Velaclaw checks for auth keys in this order:
