---
title: "fal"
summary: "fal image and video generation setup in Velaclaw"
read_when:
  - You want to use fal image generation in Velaclaw
...
Velaclaw ships a bundled `fal` provider for hosted image and video generation.
...
<Tip>
Use `velaclaw models list --provider fal` to see the full list of available fal
