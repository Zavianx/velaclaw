---
title: "LiteLLM"
summary: "Run Velaclaw through LiteLLM Proxy for unified model access and cost tracking"
read_when:
  - You want to route Velaclaw through a LiteLLM proxy
  - You need cost tracking, logging, or model routing through LiteLLM
---

# LiteLLM

[LiteLLM](https://litellm.ai) is an open-source LLM gateway that provides a unified API to 100+ model providers. Route Velaclaw through LiteLLM to get centralized cost tracking, logging, and the flexibility to switch backends without changing your Velaclaw config.

<Tip>
**Why use LiteLLM with Velaclaw?**

- **Cost tracking** — See exactly what Velaclaw spends across all models
...
<AccordionGroup>
  <Accordion title="Virtual keys">
    Create a dedicated key for Velaclaw with spend limits:
  ...
  <Accordion title="Model routing">
    ...
    Velaclaw keeps requesting `claude-opus-4-6` — LiteLLM handles the routing.
  ...
  <Accordion title="Proxy behavior notes">
    ...
    - Velaclaw connects through LiteLLM's proxy-style OpenAI-compatible `/v1`
      endpoint
