...
read_when:
  - You want to use Cloudflare AI Gateway with Velaclaw
  - You need the account ID, gateway ID, or API key env var
---

# Cloudflare AI Gateway

Cloudflare AI Gateway sits in front of provider APIs and lets you add analytics, caching, and controls. For Anthropic, Velaclaw uses the Anthropic Messages API through your Gateway endpoint.
...
<Steps>
  <Step title="Set the provider API key and Gateway details">
    ...
    ```bash
    velaclaw onboard --auth-choice cloudflare-ai-gateway-api-key
    ```
  ...
  <Step title="Set a default model">
    Add the model to your Velaclaw config:
