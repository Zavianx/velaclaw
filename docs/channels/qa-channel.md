---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic Velaclaw QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Velaclaw QA.
...
- Velaclaw-native orchestration later
