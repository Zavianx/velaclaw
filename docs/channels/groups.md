...
Velaclaw treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

Velaclaw “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Velaclaw can see that group and respond there.
...
Translation: allowlisted senders can trigger Velaclaw by mentioning it.
...
By default, Velaclaw prioritizes normal chat behavior and keeps context mostly as received. This means allowlists primarily decide who can trigger actions, not a universal redaction boundary for every quoted or historical snippet.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@velaclaw", "velaclaw", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
