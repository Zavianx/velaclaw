---
summary: "CLI reference for `velaclaw skills` (search/install/update/list/info/check)"
read_when:
...
velaclaw skills search --limit 20 --json
velaclaw skills install <slug>
velaclaw skills install <slug> --version <version>
velaclaw skills install <slug> --force
velaclaw skills update <slug>
velaclaw skills update --all
velaclaw skills list
velaclaw skills list --eligible
velaclaw skills list --json
velaclaw skills list --verbose
velaclaw skills info <name>
velaclaw skills info <name> --json
velaclaw skills check
velaclaw skills check --json
```
