...
Velaclaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.velaclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["velaclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
