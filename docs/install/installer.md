...
read_when:
  - You want to understand `velaclaw.ai/install.sh`
...
| ---------------------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------- |
| [`install.sh`](#installsh)         | macOS / Linux / WSL  | Installs Node if needed, installs Velaclaw via npm (default) or git, and can run onboarding.                   |
| [`install-cli.sh`](#install-clish) | macOS / Linux / WSL  | Installs Node + Velaclaw into a local prefix (`~/.velaclaw`) with npm or git checkout modes. No root required. |
| [`install.ps1`](#installps1)       | Windows (PowerShell) | Installs Node if needed, installs Velaclaw via npm (default) or git, and can run onboarding.                   |
...
<Tabs>
  <Tab title="install.sh">
    ...
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://velaclaw.ai/install.sh | bash -s -- --help
    ```
  ...
  <Tab title="install-cli.sh">
    ...
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://velaclaw.ai/install-cli.sh | bash -s -- --help
    ```
  ...
  <Tab title="install.ps1">
    ...
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://velaclaw.ai/install.ps1))) -Tag beta -NoOnboard -DryRun
    ```
...
<Note>
If install succeeds but `velaclaw` is not found in a new terminal, see [Node.js troubleshooting](/install/node#troubleshooting).
</Note>
...
| `--git-dir <path>`                    | Checkout directory (default: `~/velaclaw`). Alias: `--dir` |
...
| ------------------------------------------------------- | --------------------------------------------- |
| `VELACLAW_INSTALL_METHOD=git\|npm`                      | Install method                                |
| `VELACLAW_VERSION=latest\|next\|main\|<semver>\|<spec>` | npm version, dist-tag, or package spec        |
| `VELACLAW_BETA=0\|1`                                    | Use beta if available                         |
| `VELACLAW_GIT_DIR=<path>`                               | Checkout directory                            |
| `VELACLAW_GIT_UPDATE=0\|1`                              | Toggle git updates                            |
| `VELACLAW_NO_PROMPT=1`                                  | Disable prompts                               |
| `VELACLAW_NO_ONBOARD=1`                                 | Skip onboarding                               |
| `VELACLAW_DRY_RUN=1`                                    | Dry run mode                                  |
| `VELACLAW_VERBOSE=1`                                    | Debug mode                                    |
| `VELACLAW_NPM_LOGLEVEL=error\|warn\|notice`             | npm log level                                 |
...
(default `~/.velaclaw`) and no system Node dependency. Supports npm installs
...
| Flag                        | Description                                                                     |
| --------------------------- | ------------------------------------------------------------------------------- |
| `--prefix <path>`           | Install prefix (default: `~/.velaclaw`)                                         |
| `--install-method npm\|git` | Choose install method (default: `npm`). Alias: `--method`                       |
| `--npm`                     | Shortcut for npm method                                                         |
| `--git`, `--github`         | Shortcut for git method                                                         |
| `--git-dir <path>`          | Git checkout directory (default: `~/velaclaw`). Alias: `--dir`                  |
| `--version <ver>`           | Velaclaw version or dist-tag (default: `latest`)                                |
| `--node-version <ver>`      | Node version (default: `22.22.0`)                                               |
| `--json`                    | Emit NDJSON events                                                              |
| `--onboard`                 | Run `velaclaw onboard` after install                                            |
...
| Variable                                    | Description                                   |
| ------------------------------------------- | --------------------------------------------- |
| `VELACLAW_PREFIX=<path>`                    | Install prefix                                |
| `VELACLAW_INSTALL_METHOD=git\|npm`          | Install method                                |
| `VELACLAW_VERSION=<ver>`                    | Velaclaw version or dist-tag                  |
| `VELACLAW_NODE_VERSION=<ver>`               | Node version                                  |
| `VELACLAW_GIT_DIR=<path>`                   | Git checkout directory for git installs       |
| `VELACLAW_GIT_UPDATE=0\|1`                  | Toggle git updates for existing checkouts     |
| `VELACLAW_NO_ONBOARD=1`                     | Skip onboarding                               |
| `VELACLAW_NPM_LOGLEVEL=error\|warn\|notice` | npm log level                                 |
| `SHARP_IGNORE_GLOBAL_LIBVIPS=0\|1`          | Control sharp/libvips behavior (default: `1`) |
...
| `-GitDir <path>`            | Checkout directory (default: `%USERPROFILE%\velaclaw`)     |
...
| `VELACLAW_GIT_DIR=<path>`          | Checkout directory |
| `VELACLAW_NO_ONBOARD=1`            | Skip onboarding    |
| `VELACLAW_GIT_UPDATE=0`            | Disable git pull   |
| `VELACLAW_DRY_RUN=1`               | Dry run mode       |
...
<AccordionGroup>
  ...
  <Accordion title="sharp/libvips issues">
    ...
    ```bash
    SHARP_IGNORE_GLOBAL_LIBVIPS=0 curl -fsSL --proto '=https' --tlsv1.2 https://velaclaw.ai/install.sh | bash
    ```
