---
summary: "ClawDock shell helpers for Docker-based Velaclaw installs"
read_when:
  - You run Velaclaw with Docker often and want shorter day-to-day commands
...
ClawDock is a small shell-helper layer for Docker-based Velaclaw installs.
...
| `clawdock-cli <command>`  | Run Velaclaw CLI commands in Docker           |
