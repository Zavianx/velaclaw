...
summary: "What experimental flags mean in Velaclaw and which ones are currently documented"
read_when:
...
Experimental features in Velaclaw are **opt-in preview surfaces**. They are
...
- If you are rolling Velaclaw out broadly, test experimental flags in a smaller
...
| ------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Local model runtime      | `agents.defaults.experimental.localModelLean`             | A smaller or stricter local backend chokes on Velaclaw's full default tool surface                             | [Local Models](/gateway/local-models)                                                         |
...
If a feature is experimental, Velaclaw should say so plainly in docs and in the
