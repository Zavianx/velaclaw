...
This page ties together how Velaclaw handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Velaclaw keeps a
...
Velaclaw separates the **prompt body** from the **command body**:
...
Velaclaw can expose or hide model reasoning:
