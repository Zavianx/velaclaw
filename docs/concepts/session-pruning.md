...
Velaclaw also runs a separate idempotent cleanup for older legacy sessions that
...
Velaclaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Velaclaw does not override them.
