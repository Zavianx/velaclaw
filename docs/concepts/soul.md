---
summary: "Use SOUL.md to give your Velaclaw agent an actual voice instead of generic assistant sludge"
read_when:
...
Velaclaw injects it on normal sessions, so it has real weight. If your agent
...
For Velaclaw, `SOUL.md` is that layer.
...
Path fixed for Velaclaw workspaces: use `SOUL.md`, not `http://SOUL.md`.
